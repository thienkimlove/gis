...
<style>
    ...
    <div class="form-group1">
        <div class="col-md-12 creatingmap-title" style="color: #ffffff">
            <span style="font-size: 30px;">{{ trans('common.title_create_fertilizer_map') }}</span>
        ...
        <div id="data-input" class="col-md-12 creatingmap-wapper maptext" onclick="creatingmap.setEdited();">
            <input type="hidden" value='{!! $initData !!}' id="init-data"/>
            ...
            <div class="col-md-6" style="background-color: #FFFBD3;">
                ...
                <div class="col-md-12  form-inline">
                    ...
                    {!! Form::select('crops_id', $crops, $crop->id,
                    array('id'=>'crops_id','class' => 'form-control crops_id col-md-5', 'onchange'=>'creatingmap.changeFertilizer();','autofocus')) !!}
                    <input type="hidden" id="fertilizer_map_id" name="fertilizer_map_id"
                           value="{{ $fertilizerMap->id }}"/>
                    ...
                    <input id="polygonSelectionAreaForFertilizerCreationConfirmation"
                           name="polygonSelectionAreaForFertilizerCreationConfirmation" value="{{$fertilizerMap->geo}}" style="display:none;">
                    <input id="is_recreate_fertilizer_map"
                           name="is_recreate_fertilizer_map" value="{{$isRecreate}}" style="display:none;">
                ...
                <fieldset class="col-md-12 panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="radio">
                            <label>
                                <input type="radio" name="fertilizing_machine_type" id="optionsRadios1" value="1"
                                       onchange="creatingmap.changeMachineType();">
                                {{ trans('common.create_fertilizer_map_label_radio_button_1') }}
                            </label><br>

                            <div id="machine_type_1">
                                <div class="legend-level2">

                                    <div class="table-name">{{ trans('common.create_fertilizer_map_label_table_1') }}</div>
                                ...
                                <div class="col-md-11 col-md-offset-1">
                                    <div class="radio">
                                        ...
                                        <label>
                                            <input type="radio" tabindex="201" id="control_methodology_11"
                                                   name="control_methodology" value="1" onchange="creatingmap.changeControlMethod();">{{ trans('common.create_fertilizer_map_radio_button_1.1') }}
                                        </label><br>

                                        <label>
                                            <input type="radio" tabindex="202" id="control_methodology_12"
                                                   name="control_methodology" value="2" onchange="creatingmap.changeControlMethod();">{{ trans('common.create_fertilizer_map_radio_button_1.2') }}
                                        </label><br>

                                        <label>
                                            <input type="radio" id="control_methodology_13" name="control_methodology"
                                                   value="3" onchange="creatingmap.changeControlMethod();">{{ trans('common.create_fertilizer_map_radio_button_1.3') }}
                                        </label><br>


                                        <label>
                                            <input type="radio" id="control_methodology_14" name="control_methodology"
                                                   value="4" onchange="creatingmap.changeControlMethod();"> {{ trans('common.create_fertilizer_map_radio_button_1.4') }}
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <label>
                                <input type="radio" name="fertilizing_machine_type" id="optionsRadios2"
                                       onchange="creatingmap.changeMachineType();" value="2">{{ trans('common.create_fertilizer_map_label_radio_button_2') }}
                            </label>
                            ...
                            <div id="machine_type_2">
                                ...
                                <div class="radio col-md-11 col-md-offset-1">
                                    <!-- lua chon 2.1 -->
                                    <label>
                                        <input onchange="creatingmap.changeControlMethodology();" type="radio"
                                               id="control_methodology_21" name="control_methodology" value="5">{{ trans('common.create_fertilizer_map_radio_button_2.1') }}
                                    </label>
                                    ...
                                    <div class="form-group form-inline" style="margin-left: 0">
                                        ...
                                        <input type="text" id="fixed_fertilizer_amount5"
                                               class="form-control onlyDecimal6_2"
                                               style="width: 50px"><span>{{ trans('common.create_fertilizer_map_radio_button_2.1.2') }}</span>
                                    </div>

                                    <label>
                                        <input onchange="creatingmap.changeControlMethodology();" type="radio"
                                               name="control_methodology" value="6">{{ trans('common.create_fertilizer_map_radio_button_2.2') }}
                                    </label>

                                    <div class="form-group form-inline" style="margin-left: 0">
                                        <label for="exampleInputName2">{{ trans('common.create_fertilizer_map_radio_button_2.2.1') }}</label>
                                        <input type="text" id="fixed_fertilizer_amount6"
                                               class="form-control onlyDecimal6_2"
                                               style="width: 50px"><span>{{ trans('common.create_fertilizer_map_radio_button_2.1.2') }}</span>
                                    </div>
                                    ...
                                    <label>
                                        <input onchange="creatingmap.changeControlMethodology();" type="radio"
                                               name="control_methodology" value="7">{{ trans('common.create_fertilizer_map_radio_button_2.3') }}
                                    </label><br>

                                    <label>
                                        <input onchange="creatingmap.changeControlMethodology();" type="radio"
                                               name="control_methodology" value="8">{{ trans('common.create_fertilizer_map_radio_button_2.4') }}
                                    </label>
                ...
                <div class="col-md-12 form-inline general-group">
                    <div class="general-row mesh-size col-md-8">
                        ...
                        {!! Form::text('mesh_size','', array('id' => 'mesh_size', 'maxlength'=>'2', 'class' => 'form-control mesh_size onlyNumeric validate[required,min[10],max[50]] ',
                    ...
                    <div class="general-row new2 col-md-6">
                        <span><span class="required-icon">{{trans('common.title_create_fertilizer_map_required')}}</span><strong>{{ trans('common.creating_fertilizer_map_label_new_value2') }}</strong></span>
            ...
            <div class="col-md-6 " style="background-color: #FFFBD3">
                <fieldset class="panel panel-primary" style="width: 100%">
                    ...
                    <div class="panel-body" style="width: 100%">
                        <div class="form-inline">
                            {!! Form::select('fertilizer_standard_definition_id', $fertilizers, $fertilizerMap->FertilizerMapProperty->fertilizer_standard_definition_id, array('id'=>'fertilizer_standard_definition_id', 'class' => 'form-control fertilizer_standard_definition_id validate[required]', 'onchange'=>'creatingmap.getFertilizers();',
                ...
                <fieldset class="panel panel-primary soil_analysis_value" style="display: block;">
                    ...
                    <label style="display: block">
                        <input type="radio" name="soil_analysis_type" id="optionsRadios1" value="1"
                               onchange="creatingmap.changeAnalysisType();" style="margin-left: 5px">{{ trans('common.create_fertilizer_map_radio_button_3.1') }}
                    </label><br>
                    <label>
                        <input type="radio" name="soil_analysis_type" id="optionsRadios2" value="2"
                               onchange="creatingmap.changeAnalysisType();" style="margin-left: 5px">{{ trans('common.create_fertilizer_map_radio_button_3.2') }}
                    </label>
                    ...
                    <div id="analysis_type_2" class="form-horizontal analysis_type_2 relative">
                        ...
                        <label class="control-label" style="margin-left: 5px">{{trans('common.option_photpho')}}
                            : </label>
                ...
                <div id="submit-group" class="button-group ">
                    ...
                    <span><button type="button" class="button-submit btn-save-fertilizer"
                                  onclick=" creatingmap.showConfirm();">{{trans('common.button_alert_ok')}}</button></span>
                    <span><button type="button" class="button-submit button-cancel-edit-fertilizer" id="button-cancel-edit-fertilizer" onclick="closeFancy();">{{trans('common.button_cancel')}}</button></span>
    ...
    <script src="{{url('/js/modules/init_fertilizer_map.js')}}"></script>
    <script>
        ...
        controlTabC('crops_id','button-cancel-edit-fertilizer');
