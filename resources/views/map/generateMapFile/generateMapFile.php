...
$rootPath = "C:/ms4w/Apache/htdocs/GenMapFile/";
...
$oLayerClouds->set( "data", $rootPath."global_clouds.tif");
...
$fPointList = file($rootPath."points.txt");
...
// Save map object to mapfile
$oMap->save($rootPath."worldmap.map");

// Render the map into an image object
$oMapImage = $oMap->draw( );

// Save the map to an image file
$oMapImage->saveImage($rootPath."worldmap.png");

$im = imagecreatefrompng($rootPath."worldmap.png");
