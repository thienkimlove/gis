...
class UserRegistrationRequest extends Request {
	...
	public function rules() {
		return array (
				...
				'password' => 'required|alpha_num|max:' . AuthenticateRequest::MAX_LENGTH_PASSWORD,
	...
	public function messages() {
		return array (
				...
				'password.required' => trans ( 'common.user_registration_password_required' ),
				...
				'user_group_id.required' => trans ( 'common.user_registration_usergroup_required' )
		);
	}
